...
public class Union<T, R> {
    ...
    public class FromClause<S, Q> {
        ...
        public final Select<S, Q> select(Class<Q> returnClass, Function<S, ?>... functions) {
        ...
        @SafeVarargs //Idea advices placing it
        public final Select<S, Q> selectDistinct(Class<Q> returnClass, Function<S, ?>... functions) {
